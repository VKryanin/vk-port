                ...
                <li>
                    <Link
                        ...
                        <div className={styles.experienceWrapper}>
                            ...
                            <p className={styles.experienceText}>Разработка внутренней CRM системы. Добавление новых модулей под запросы компании, рефакторинг прошлых модулей,
                                исправление ошибок, доработка функционала.</p>
                        </div>
                    </Link>
                </li>
                <li>
                    <Link
                        ...
                        <div className={styles.experienceWrapper}>
                            ...
                            <p className={styles.experienceText}>Проектная занятость в стартапе онлайн и офлайн курсов по "Римской мозайке" разработал несколько модулей.
                            </p>
                        </div>
                    </Link>
                </li>
