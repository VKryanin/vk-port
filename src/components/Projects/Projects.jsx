        ...
        <section id={id} className={styles.projects}>
            <div className={styles.projectsHeader}>
                ...
                <div className={styles.projectsButtons}>
                    <button className={styles.projectsButton} onClick={() => countCards(-1)}>
            ...
            <div className={styles.projectsWrapper}>
                {slider.map((item, index) =>
                    <Link to={item.link} target='_blank' className={`${styles.projectsItem} ${index === activeIndex
                        ...
                        <div className={styles.projectsContainer}>
                            ...
                            <div>
                                ...
                                <ul>
                                    {
                                        item.stack.map((tech) => {
                                            return <li className={styles.projectsTech}>
                                                {tech}
                                            </li>
                                        })
                                    }
