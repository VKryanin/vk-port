...
const slider = [
    {
        photo: itech,
        name: 'I-Tech',
        subtitle: 'Разработка внутренней CRM системы. Рефакторинг созданных ранее модулей. Добавление модулей: Учет рабочего времени, заявки на посителей, контроль статей расходов, выгрузка отчетов, создание КП с выгрузкой pdf.',
    ...
    },
    {
        ...
        subtitle: 'Мой первый коммерческий опыт работы, проектной занятости. Реализовал компоненты: Корзины, записи на курс, авторизации и регистрации.',
    ...
    },
    {
        photo: stuff,
        name: 'Stuff',
        subtitle: 'Pet-проект Интернет-магазин, созданный на публичном API. Реализован функционал: поиск товаров, фильтрация по цене и категории, а также добавление товаров в избранное и корзину, регистрация и аутентификация пользователя.',
        stack: ['React', 'Redux', 'Axios', 'Docker'],
